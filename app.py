    ...
    "Visão Geral": {
        ...
        digraph {
            ...
            subgraph cluster_simpa {
                ...
                "Nn. Esplâncnicos Torácicos (T5-T12)" -> "Plexos Pré-vertebrais (Celíaco, Mesentérico Superior)";
                "Nn. Esplâncnicos Lombares (L1-L2)" -> "Plexo Mesentérico Inferior";
            }
        }
        """,
        "clinical": {
